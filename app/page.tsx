...
export default function Home() {
  return (
    <>
    <div className="text-lg w-full h-screen flex flex-col justify-center items-center border">
      <h1>Warbler Consulting 404!</h1>
      <p className="text-red-400">check analytics</p>
    </div>
    </>
